...
public class Spieler implements OthelloSpieler {
	...
	public int berechneN‰chsterZug(Farbe[][] brett, Farbe ich, Farbe gegner, int Tiefe, int alpha, int beta) {
		int value = -1000;
		if ((Tiefe & 1) == 1) {
			value *= -1;
		}
		...
		if (Tiefe == Rekursionstiefe) {
			...
			if (ZugListe.isEmpty()) {
				...
				int temp = berechneN‰chsterZug(brettCopy, gegner, ich, (Tiefe + 1), alpha, beta);
